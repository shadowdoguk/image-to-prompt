...
| Saved palette | `data/palettes.json` | `id` (`palette_<16 hex>`) | name, colors, source_run_id, source_preset_id, created_at (ADR 0006). Selected via the Step 1 picker; overrides the auto-analyzed `colors` field when applied. |
